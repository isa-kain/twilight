...
ephemeris_path = '/Users/isabelkain/Desktop/Twilight_/twilight-observing-tool/ephemeris-tables'

# Grab sunrise times from e.g. twilight_ephemerides_keckII_2026.csv
# Query JPL Horizons SS planet ephemeris for this time
